        ...
        public override IValueObject Add(IValueObject valueObject, clsUserVO userVO)
        {
            ...
            try
            {
                ...
                foreach (clsMaterialConsumptionItemDetailsVO svo in nvo.ConsumptionDetails.ConsumptionItemDetailsList)
                {
                    ...
                    if (consumptionDetails.IsPackageConsumable)
                    {
                ...
                if (((consumptionDetails != null) && (((consumptionDetails.Opd_Ipd_External == 0L) && (consumptionDetails.IsPackageConsumable || consumptionDetails.IsAgainstPatientIndent)) || (consumptionDetails.Opd_Ipd_External == 1L))) && ((consumptionDetails.Opd_Ipd_External == 1L) || (consumptionDetails.Opd_Ipd_External == 0L)))
                {
                    ...
                    else
                    {
                        ...
                        if (((((consumptionDetails.Opd_Ipd_External == 0L) && consumptionDetails.IsAgainstPatientIndent) || (consumptionDetails.Opd_Ipd_External == 1L)) && (nvo.ConsumptionDetails.ConsumptionAmount > 0.0)) && (pharmacyFixedRate > 0.0))
                        {
