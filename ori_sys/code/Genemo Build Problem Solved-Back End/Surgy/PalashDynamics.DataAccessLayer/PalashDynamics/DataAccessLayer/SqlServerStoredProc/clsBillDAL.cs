            ...
            try
            {
                ...
                while (true)
                {
                    if (i >= objDetailsVO.ChargeDetails.Count)
                    {
                        ...
                        this.dbServer.AddInParameter(storedProcCommand, "SelectedCompanyId", DbType.Int64, objDetailsVO.SelectedCompanyId);
                        this.dbServer.AddOutParameter(storedProcCommand, "ResultStatus", DbType.Int32, 0x7fffffff);
                ...
                if (reader.HasRows)
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        else
                        {
                            ...
                            item.SelectedCompanyId = Convert.ToInt64(DALHelper.HandleDBNull(reader["SelectedCompanyId"]));
                        }
        ...
        private clsAddBillBizActionVO UpdateDetails(clsAddBillBizActionVO BizActionObj, clsUserVO UserVo)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    this.dbServer.AddInParameter(command7, "SelectedCompanyId", DbType.Int64, objDetailsVO.SelectedCompanyId);
