namespace PalashDynamics.DataAccessLayer.SqlServerStoredProc
{
    ...
    public class clsPaymentDAL : clsBasePaymentDAL
    {
        ...
        private clsAddPaymentBizActionVO AddDetails(clsAddPaymentBizActionVO BizActionObj, clsUserVO UserVo, DbConnection pConnection, DbTransaction pTransaction)
        {
            ...
            double PatientDailyCashAmount = 0;
            ...
            //    DbCommand storedProcCommand1 = this.dbServer.GetStoredProcCommand("CIMS_GetPatientDailyCashAmount");
            //    this.dbServer.AddInParameter(storedProcCommand1, "BillId", DbType.Int64, details.BillID);
            //    this.dbServer.AddInParameter(storedProcCommand1, "UnitID", DbType.Int64, UserVo.UserLoginInfo.UnitId);
            //    this.dbServer.AddParameter(storedProcCommand1, "PatientDailyCashAmount", DbType.Double, ParameterDirection.InputOutput, null, DataRowVersion.Default, PatientDailyCashAmount);
            //   // DbDataReader reader = (DbDataReader)this.dbServer.ExecuteReader(storedProcCommand1);
              



            //    this.dbServer.ExecuteNonQuery(storedProcCommand1);

            //    PatientDailyCashAmount = (double)this.dbServer.GetParameterValue(storedProcCommand1, "PatientDailyCashAmount");




            //    if (PatientDailyCashAmount >= 200000)
            //    {
            //        this.logManager.LogError(UserVo.ID, DateTime.Now, MethodBase.GetCurrentMethod().DeclaringType.ToString(), MethodBase.GetCurrentMethod().ToString(), "More than 200000 cash can not be paid/deposited ");
            //        //throw new Exception("More than 200000 cash can not be paid/deposited");
            ...
            //    else
            //    {
            //        this.logManager.LogError(UserVo.ID, DateTime.Now, MethodBase.GetCurrentMethod().DeclaringType.ToString(), MethodBase.GetCurrentMethod().ToString(), PatientDailyCashAmount.ToString() + "-cash amount");
            ...
            //{
            //    //connection.Close();
            //    this.logManager.LogError(UserVo.ID, DateTime.Now, MethodBase.GetCurrentMethod().DeclaringType.ToString(), MethodBase.GetCurrentMethod().ToString(), ex.ToString());
            //    BizActionObj.SuccessStatus = -1;
            //    return BizActionObj;
            //}
            //finally
            //{
            //    this.logManager.LogError(UserVo.ID, DateTime.Now, MethodBase.GetCurrentMethod().DeclaringType.ToString(), MethodBase.GetCurrentMethod().ToString(), "Eoor Success-nt");
