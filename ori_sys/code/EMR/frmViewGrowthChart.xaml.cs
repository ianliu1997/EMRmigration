...
namespace EMR
{
    public partial class frmViewGrowthChart : UserControl
    {
        ...
        public frmViewGrowthChart(bool chartType0to2)
        {
            InitializeComponent();
            viewAll = false;
        ...
        public frmViewGrowthChart(bool chartType0to2, clsGrowthChartVO ChartDetails)
        {
            InitializeComponent();
        ...
        public frmViewGrowthChart(bool chartType0to2, long PatientID, long lVisitId, string PatientName, string MrNo, int GenderID)
        {
            InitializeComponent();
            viewAll = true;
        ...
        private void OKButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (CheckEmpty() == false)
            {
                ...
                else
                {
                    ...
                    string URL = address + PatientName + "&GenderID=" + GenderID + "&MrNo=" + MrNo + "&PatientID=" + PatientID + "&DrID=" + VisitID + "&Comments=" + txtComments.Text + "&UnitID=" + ((IApplicationConfiguration)App.Current).CurrentUser.UserLoginInfo.UnitId + "&Isopdipd=0";
