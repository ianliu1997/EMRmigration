...
namespace EMR
{
    public partial class frmIPDPatientEMRRefferal : UserControl
    {
        public clsPatientGeneralVO PatientDetail = new clsPatientGeneralVO();
        public frmIPDPatientEMRRefferal()
        {
            InitializeComponent();
        ...
        bool checkValidation()
        {
            ...
            {
                string msgText = "Please Select Specialization";//((IApplicationConfiguration)App.Current).LocalizedManager.GetValue("Msg_SelectSpecial");
        ...
        {
            if (CurrentVisit != null)
                HtmlPage.Window.Navigate(new Uri(Application.Current.Host.Source, "../Reports/EMR/AllReferralLetterPrint.aspx?VisitID=" + CurrentVisit.ID + "&PatientID=" + ((IApplicationConfiguration)App.Current).SelectedIPDPatient.PatientId + "&PrescriptionID=" + ((clsDoctorSuggestedServiceDetailVO)dgReferralList.SelectedItem).PrescriptionID + "&ID=" + ((clsDoctorSuggestedServiceDetailVO)dgReferralList.SelectedItem).ID + "&UnitID="+CurrentVisit.UnitId), "_blank");
        }
        ...
        public void OpenReferal(bool IsFromReferral)
        {
            ...
            EMR.frmIPDEMR winEMR = ((this.Parent) as ContentControl).FindAncestor<UserControl>() as frmIPDEMR;
