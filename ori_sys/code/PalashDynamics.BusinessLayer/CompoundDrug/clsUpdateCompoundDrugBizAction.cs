...
{
    internal class clsUpdateCompoundDrugBizAction:BizAction
    {
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsUpdateCompoundDrugBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsUpdateCompoundDrugBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBaseCompoundDrugDAL objBaseDAL = clsBaseCompoundDrugDAL.GetInstance();
                        obj = (clsUpdateCompoundDrugBizActionVO)objBaseDAL.UpdateCompoundDrugByIDAndUnitID(valueObject,objUserVO);
                }
        ...
        private clsUpdateCompoundDrugBizAction()
        {
        ...
        private static clsUpdateCompoundDrugBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsUpdateCompoundDrugBizAction();
