...
{
   internal class clsGetCompoundDrugDetailsBizAction:BizAction
    {
       protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsGetCompoundDrugDetailsBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetCompoundDrugDetailsBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBaseCompoundDrugDAL objBaseDAL = clsBaseCompoundDrugDAL.GetInstance();
                    obj = (clsGetCompoundDrugDetailsBizActionVO)objBaseDAL.GetCompoundDrugDetails(obj, objUserVO);
        ...
        private clsGetCompoundDrugDetailsBizAction()
        {
        ...
        private static clsGetCompoundDrugDetailsBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsGetCompoundDrugDetailsBizAction();
