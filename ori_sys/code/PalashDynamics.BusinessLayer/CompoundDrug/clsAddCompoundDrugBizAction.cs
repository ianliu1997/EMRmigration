...
{
   internal class clsAddCompoundDrugBizAction : BizAction
    {
       protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsAddCompoundDrugBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddCompoundDrugBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBaseCompoundDrugDAL objBaseDAL = clsBaseCompoundDrugDAL.GetInstance();
                        obj = (clsAddCompoundDrugBizActionVO)objBaseDAL.AddCompoundDrug(valueObject,objUserVO);
                }
        ...
        private clsAddCompoundDrugBizAction()
        {
        ...
        private static clsAddCompoundDrugBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsAddCompoundDrugBizAction();
