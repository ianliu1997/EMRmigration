...
{
    public class clsAddEMRTemplateBizAction : BizAction
    {
        ...
        private clsAddEMRTemplateBizAction()
        {
        ...
        private static clsAddEMRTemplateBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsAddEMRTemplateBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddEMRTemplateBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddEMRTemplateBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsAddEMRTemplateBizActionVO)objBaseDAL.AddEMRTemplate(obj, objUserVO);
                }
            }
