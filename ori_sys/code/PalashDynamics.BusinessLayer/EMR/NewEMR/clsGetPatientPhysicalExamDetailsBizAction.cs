...
//Specification: BizAction For Get Patient EMR Physical Exam
...
{
    class clsGetPatientPhysicalExamDetailsBizAction: BizAction
    {
        ...
        private clsGetPatientPhysicalExamDetailsBizAction()
        {
        ...
        private static clsGetPatientPhysicalExamDetailsBizAction _Instance = null;
        ///Name:GetInstance       
        ///Type:static
        ///Direction:None
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPatientPhysicalExamDetailsBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPatientPhysicalExamDetailsBizActionVO obj = null;
            //int ResultStatus = 0;
            try
            {
                obj = (clsGetPatientPhysicalExamDetailsBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetPatientPhysicalExamDetailsBizActionVO)objBaseDAL.GetPatientPhysicalExamDetails(obj, objUserVO);
                }
            }
