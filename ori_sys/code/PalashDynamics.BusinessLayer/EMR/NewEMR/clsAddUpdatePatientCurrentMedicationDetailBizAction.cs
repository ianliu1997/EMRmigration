...
{
    class clsAddUpdatePatientCurrentMedicationDetailBizAction: BizAction
    {
        ...
        private clsAddUpdatePatientCurrentMedicationDetailBizAction()
        {
        ...
        private static clsAddUpdatePatientCurrentMedicationDetailBizAction _Instance = null;
        ///Name:GetInstance       
        ///Type:static
        ///Direction:None
        ...
        {
            if (_Instance == null)
                _Instance = new clsAddUpdatePatientCurrentMedicationDetailBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddUpdatePatientCurrentMedicationDetailBizActionVO obj = null;
            //int ResultStatus = 0;
            try
            {
                obj = (clsAddUpdatePatientCurrentMedicationDetailBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsAddUpdatePatientCurrentMedicationDetailBizActionVO)objBaseDAL.AddUpdatePatientCurrentMedicationDetail(obj, objUserVO);
                }
            }
