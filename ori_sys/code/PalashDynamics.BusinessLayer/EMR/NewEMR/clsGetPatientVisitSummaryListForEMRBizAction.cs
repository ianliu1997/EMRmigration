...
{
    class clsGetPatientVisitSummaryListForEMRBizAction: BizAction
    {
        ...
        private clsGetPatientVisitSummaryListForEMRBizAction()
        {
        ...
        private static clsGetPatientVisitSummaryListForEMRBizAction _Instance = null;
        ///Name:GetInstance       
        ///Type:static
        ///Direction:None
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPatientVisitSummaryListForEMRBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPatientVisitSummaryListForEMRBizActionVO obj = null;
            //int ResultStatus = 0;
            try
            {
                obj = (clsGetPatientVisitSummaryListForEMRBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetPatientVisitSummaryListForEMRBizActionVO)objBaseDAL.GetPatientVisitSummaryDetails(obj, objUserVO);
                }
            }
