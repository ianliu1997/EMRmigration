...
//Specification: BizAction For Item Details With Molecule Name
...
{
    class clsGetItemMoleculeNameBizAction: BizAction
    {
        ...
        private clsGetItemMoleculeNameBizAction()
        {
        ...
        private static clsGetItemMoleculeNameBizAction _Instance = null;
        ///Name:GetInstance       
        ///Type:static
        ///Direction:None
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetItemMoleculeNameBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetItemMoleculeNameBizActionVO obj = null;
            //int ResultStatus = 0;
            try
            {
                obj = (clsGetItemMoleculeNameBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetItemMoleculeNameBizActionVO)objBaseDAL.GetItemMoleculeNameList(obj, objUserVO);
                }
            }
