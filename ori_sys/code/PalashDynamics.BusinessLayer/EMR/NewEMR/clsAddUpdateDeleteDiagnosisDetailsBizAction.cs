...
{
    public class clsAddUpdateDeleteDiagnosisDetailsBizAction : BizAction
    {
        ...
        private clsAddUpdateDeleteDiagnosisDetailsBizAction()
        {
        ...
        private static clsAddUpdateDeleteDiagnosisDetailsBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsAddUpdateDeleteDiagnosisDetailsBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddUpdateDeleteDiagnosisDetailsBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddUpdateDeleteDiagnosisDetailsBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsAddUpdateDeleteDiagnosisDetailsBizActionVO)objBaseDAL.AddUpdateDeleteDiagnosisDetailsBizAction(obj, objUserVO);
                }
            }
