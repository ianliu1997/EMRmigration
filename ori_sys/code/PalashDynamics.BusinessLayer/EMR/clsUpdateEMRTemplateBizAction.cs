...
{
    public class clsUpdateEMRTemplateBizAction : BizAction
    {
        ...
        private clsUpdateEMRTemplateBizAction()
        {
        ...
        private static clsUpdateEMRTemplateBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsUpdateEMRTemplateBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsUpdateEMRTemplateBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsUpdateEMRTemplateBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsUpdateEMRTemplateBizActionVO)objBaseDAL.UpdateEMRTemplate(obj, objUserVO);
                }
            }
