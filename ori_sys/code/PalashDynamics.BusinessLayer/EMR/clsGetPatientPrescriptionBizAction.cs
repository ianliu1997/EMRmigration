...
{
    public class clsGetPatientPrescriptionBizAction : BizAction
    {
        ...
        private clsGetPatientPrescriptionBizAction()
        {
        ...
        private static clsGetPatientPrescriptionBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPatientPrescriptionBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPatientPrescriptionBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetPatientPrescriptionBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetPatientPrescriptionBizActionVO)objBaseDAL.GetPatientPrescription(obj, objUserVO);
                }
            }
