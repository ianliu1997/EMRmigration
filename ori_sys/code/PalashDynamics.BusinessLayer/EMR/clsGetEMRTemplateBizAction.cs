...
{
    public class clsGetEMRTemplateBizAction : BizAction
    {
        ...
        private clsGetEMRTemplateBizAction()
        {
        ...
        private static clsGetEMRTemplateBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetEMRTemplateBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetEMRTemplateBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetEMRTemplateBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetEMRTemplateBizActionVO)objBaseDAL.GetEMRTemplate(obj, objUserVO);
                }
            }
