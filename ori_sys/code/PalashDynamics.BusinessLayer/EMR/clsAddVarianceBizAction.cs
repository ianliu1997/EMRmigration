...
{
    public class clsAddVarianceBizAction : BizAction
    {
        ...
        private clsAddVarianceBizAction()
        {
        ...
        private static clsAddVarianceBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsAddVarianceBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddVarianceBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddVarianceBizActionVO)valueObject;
                //obj.OPDPatientDetails.AddedBy = objUserVO.ID;
                //obj.OPDPatientDetails.UpdatedBy = objUserVO.ID;
                //Typecast the "valueObject" to "clsInputOutputVO"
                if (obj != null)
                {
                    clsBaseVarianceDAL objBaseDAL = clsBaseVarianceDAL.GetInstance();
                    obj = (clsAddVarianceBizActionVO)objBaseDAL.AddVariance(obj, objUserVO);
                }
            }
