...
{
    internal class clsAddCityBizAction : BizAction
    {
        ...
        private static clsAddCityBizAction _Instance = null;
        /// <summary>
        ...
        public static BizAction GetInstance()
        {
            if (_Instance == null)
            {
                _Instance = new clsAddCityBizAction();
            }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddCityBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddCityBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseLocationDAL objBaseLocationDAL = clsBaseLocationDAL.GetInstance();
                    obj = (clsAddCityBizActionVO)objBaseLocationDAL.AddCityInfo(obj, objUserVO);
                }
            }
            catch (Exception ex)
            {
