...
{
    internal class clsAddDistBizAction : BizAction
    {
        ...
        private static clsAddDistBizAction _Instance = null;
        /// <summary>
        ...
        public static BizAction GetInstance()
        {
            if (_Instance == null)
            {
                _Instance = new clsAddDistBizAction();
            }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddDistBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddDistBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseLocationDAL objBaseLocationDAL = clsBaseLocationDAL.GetInstance();
                    obj = (clsAddDistBizActionVO)objBaseLocationDAL.AddDistInfo(obj, objUserVO);
                }
            }
            catch (Exception ex)
            {
