...
{
    internal class clsAddCountryBizAction : BizAction
    {
        ...
        private static clsAddCountryBizAction _Instance = null;
        /// <summary>
        ...
        public static BizAction GetInstance()
        {
            if (_Instance == null)
            {
                _Instance = new clsAddCountryBizAction();
            }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddCountryBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddCountryBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseLocationDAL objBaseLocationDAL = clsBaseLocationDAL.GetInstance();
                    obj = (clsAddCountryBizActionVO)objBaseLocationDAL.AddCountryInfo(obj, objUserVO);
                }
            }
            catch (Exception ex)
            {
