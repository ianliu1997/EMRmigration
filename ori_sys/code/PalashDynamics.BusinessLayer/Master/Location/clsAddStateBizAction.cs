...
{
    internal class clsAddStateBizAction : BizAction
    {
        ...
        private static clsAddStateBizAction _Instance = null;
        /// <summary>
        ...
        public static BizAction GetInstance()
        {
            if (_Instance == null)
            {
                _Instance = new clsAddStateBizAction();
            }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddStateBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddStateBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseLocationDAL objBaseLocationDAL = clsBaseLocationDAL.GetInstance();
                    obj = (clsAddStateBizActionVO)objBaseLocationDAL.AddStateInfo(obj, objUserVO);
                }
            }
            catch (Exception ex)
            {
