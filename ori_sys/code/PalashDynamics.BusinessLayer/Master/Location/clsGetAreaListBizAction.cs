...
{
    internal class clsGetAreaListBizAction : BizAction
    {
        private clsGetAreaListBizAction()
        {
        }
        private static clsGetAreaListBizAction _Instance = null;
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsGetAreaListBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetAreaListBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetAreaListBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseLocationDAL objBaseDoctorDAL = clsLocationDAL.GetInstance();
                    obj = (clsGetAreaListBizActionVO)objBaseDoctorDAL.GetAreaList(obj, objUserVO);
                }
            }
            catch (Exception ex)
            {
