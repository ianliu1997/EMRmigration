...
//Specification: Biz Action for Display Unit Contact No
...
{
    class clsGetUnitContactNoBizAction: BizAction
    {
        ...
        private clsGetUnitContactNoBizAction()
        {
        ...
        private static clsGetUnitContactNoBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetUnitContactNoBizAction();
            return _Instance;
        }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
           // bool CurrentMethodExecutionStatus = true;
            clsGetUnitContactNoBizActionVO obj = null;
            //int ResultStatus = 0;
            try
            {
                obj = (clsGetUnitContactNoBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetUnitContactNoBizActionVO)objBaseDAL.GetUnitContactNo(obj, objUserVO);
                }
            }
