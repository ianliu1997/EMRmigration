...
{
   internal class clsAddVisitTypeBizAction:BizAction
    {
        ...
        private clsAddVisitTypeBizAction()
        {
        ...
        private static clsAddVisitTypeBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsAddVisitTypeBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddVisitTypeBizActionVO obj = null;
           
            try
            {
                obj = (clsAddVisitTypeBizActionVO)valueObject;

                //Typecast the "valueObject" to "clsInputOutputVO"
                if (obj != null)
                {
                    clsBaseVisitTypeDAL objBaseRoleDAL = clsBaseVisitTypeDAL.GetInstance();
                    obj = (clsAddVisitTypeBizActionVO)objBaseRoleDAL.AddVisitType(obj, objUserVO);
                }
            }
