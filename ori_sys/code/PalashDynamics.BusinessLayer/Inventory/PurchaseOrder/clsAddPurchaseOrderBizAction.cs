...
{
    internal class clsAddPurchaseOrderBizAction:BizAction
    {
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsAddPurchaseOrderBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddPurchaseOrderBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBasePurchaseOrderDAL objBaseDAL = clsBasePurchaseOrderDAL.GetInstance();
                    obj = (clsAddPurchaseOrderBizActionVO)objBaseDAL.AddPurchaseOrder(obj, objUserVO);
        ...
        private clsAddPurchaseOrderBizAction()
        {
        ...
        private static clsAddPurchaseOrderBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsAddPurchaseOrderBizAction();

            return _Instance;
        } 
    }
    internal class clsCancelPurchaseOrderBizAction : BizAction
    {
        #region Variables Declaration
        //Declare the LogManager object
        LogManager logManager = null;
        ...
        {
            bool CurrentMethodExecutionStatus = true;
            clsCancelPurchaseOrderBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsCancelPurchaseOrderBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBasePurchaseOrderDAL objBaseDAL = clsBasePurchaseOrderDAL.GetInstance();
                    obj = (clsCancelPurchaseOrderBizActionVO)objBaseDAL.CancelPurchaseOrder(obj, objUserVO);
        ...
        private clsCancelPurchaseOrderBizAction()
        {
            //Create Instance of the LogManager object 
            #region Logging Code
            if (logManager == null)
        ...
        //The Private declaration
        private static clsCancelPurchaseOrderBizAction _Instance = null;


        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsCancelPurchaseOrderBizAction();
