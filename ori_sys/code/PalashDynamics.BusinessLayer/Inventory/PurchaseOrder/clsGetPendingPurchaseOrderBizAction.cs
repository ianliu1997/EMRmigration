...
{
   internal class clsGetPendingPurchaseOrderBizAction:BizAction
    {
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPendingPurchaseOrderBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetPendingPurchaseOrderBizActionVO)valueObject;

                if (obj != null)
                {

                    clsBasePurchaseOrderDAL objBaseDAL = clsBasePurchaseOrderDAL.GetInstance();
                    obj = (clsGetPendingPurchaseOrderBizActionVO)objBaseDAL.GetPendingPurchaseOrder(obj, objUserVO);
        ...
        private clsGetPendingPurchaseOrderBizAction()
        {
        ...
        private static clsGetPendingPurchaseOrderBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsGetPendingPurchaseOrderBizAction();
