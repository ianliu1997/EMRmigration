...
{
    internal class clsGetQuotationDetailsBizAction:BizAction
    {
         protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsGetQuotationDetailsBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetQuotationDetailsBizActionVO)valueObject;

                if (obj != null)
                {
                  
                        clsBaseQuotationDAL objBaseDAL = clsBaseQuotationDAL.GetInstance();
                        obj = (clsGetQuotationDetailsBizActionVO)objBaseDAL.GetQuotationDetails(obj, objUserVO);
        ...
        private clsGetQuotationDetailsBizAction()
        {
        ...
        private static clsGetQuotationDetailsBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsGetQuotationDetailsBizAction();
