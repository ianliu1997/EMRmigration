...
{
    internal class clsGetQuotationBizAction:BizAction
    {
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsGetQuotationBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetQuotationBizActionVO)valueObject;

                if (obj != null)
                {
                  
                        clsBaseQuotationDAL objBaseDAL = clsBaseQuotationDAL.GetInstance();
                        obj = (clsGetQuotationBizActionVO)objBaseDAL.GetQuotation(obj, objUserVO);
        ...
        private clsGetQuotationBizAction()
        {
        ...
        private static clsGetQuotationBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsGetQuotationBizAction();
