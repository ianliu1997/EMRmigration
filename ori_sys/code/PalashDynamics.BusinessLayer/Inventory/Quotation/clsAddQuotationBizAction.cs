...
{
    internal class clsAddQuotationBizAction:BizAction
    {
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsAddQuotationBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsAddQuotationBizActionVO)valueObject;

                if (obj != null)
                {
                  
                        clsBaseQuotationDAL objBaseDAL = clsBaseQuotationDAL.GetInstance();
                        obj = (clsAddQuotationBizActionVO)objBaseDAL.AddQuotation(obj, objUserVO);
        ...
        private clsAddQuotationBizAction()
        {
        ...
        private static clsAddQuotationBizAction _Instance = null;

       
        public static BizAction GetInstance()
        {
            if (_Instance == null)
                _Instance = new clsAddQuotationBizAction();
