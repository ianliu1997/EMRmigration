...
namespace PalashDynamics.BusinessLayer.Patient
{
    ...
    internal class clsGetPatientPenPusherDetailListBizAction : BizAction 
    {
        ...
        private clsGetPatientPenPusherDetailListBizAction()
        {
        ...
        private static clsGetPatientPenPusherDetailListBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPatientPenPusherDetailListBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPatientPenPusherDetailListBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetPatientPenPusherDetailListBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetPatientPenPusherDetailListBizActionVO)objBaseDAL.GetPatientPenPusherDetailsList(obj, objUserVO);
                }
            }
