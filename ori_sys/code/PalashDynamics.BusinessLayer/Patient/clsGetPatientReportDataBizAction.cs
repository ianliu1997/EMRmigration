...
{
    internal class clsGetPatientLabUploadReportDataBizAction : BizAction
    {
        ...
        private clsGetPatientLabUploadReportDataBizAction()
        {
        ...
        private static clsGetPatientLabUploadReportDataBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPatientLabUploadReportDataBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPatientLabUploadReportDataBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetPatientLabUploadReportDataBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBasePatientDAL objBaseDAL = clsBasePatientDAL.GetInstance();
                    obj = (clsGetPatientLabUploadReportDataBizActionVO)objBaseDAL.GetPatientLabUploadReportData(obj, objUserVO);
                }
            }
