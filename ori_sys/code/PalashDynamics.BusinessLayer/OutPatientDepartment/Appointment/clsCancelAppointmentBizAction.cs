...
{
   public class clsCancelAppointmentBizAction:BizAction
    {
        ...
        public clsCancelAppointmentBizAction()
        {
            #region Logging Code
            if (logManager == null)
            {
        ...
        private static clsCancelAppointmentBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsCancelAppointmentBizAction();
            return _Instance;
        }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsCancelAppointmentBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsCancelAppointmentBizActionVO)valueObject;

                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsCancelAppointmentBizActionVO)objBaseAppointmentDAL.CancelAppointment(obj, objUserVO);
