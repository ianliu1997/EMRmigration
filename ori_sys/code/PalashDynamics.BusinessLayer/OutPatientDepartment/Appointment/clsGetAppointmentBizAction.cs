...
{
   internal class clsGetAppointmentBizAction:BizAction
    {
        ...
        public clsGetAppointmentBizAction()
        {
        ...
        private static clsGetAppointmentBizAction  _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetAppointmentBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetAppointmentBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetAppointmentBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsGetAppointmentBizActionVO)objBaseAppointmentDAL.GetAppointmentDetails(obj, objUserVO);
                }
            }
