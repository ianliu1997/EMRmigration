...
{
  internal  class clsCheckMRnoBizAction:BizAction
    {
      //This Region Contains Variables Which are Used At Form Level
        ...
        private static clsCheckMRnoBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsCheckMRnoBizAction();
            return _Instance;
        }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsCheckMRnoBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsCheckMRnoBizActionVO)valueObject;

                //Typecast the "valueObject" to "clsInputOutputVO"
                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsCheckMRnoBizActionVO)objBaseAppointmentDAL.CheckMRNO(obj, objUserVO);
                }
