...
{
    internal class clsGetPastAppointmentBizAction : BizAction
    {
        ...
        public clsGetPastAppointmentBizAction()
        {
        ...
        private static clsGetPastAppointmentBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetPastAppointmentBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetPastAppointmentBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetPastAppointmentBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsGetPastAppointmentBizActionVO)objBaseAppointmentDAL.GetPastAppointment(obj, objUserVO);
                }
            }
