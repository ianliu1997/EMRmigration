...
{
   internal class clsCheckMarkVisitBizAction:BizAction
    {
        ...
        public clsCheckMarkVisitBizAction()
        {
        ...
        private static clsCheckMarkVisitBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsCheckMarkVisitBizAction();
            return _Instance;
        }
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsCheckMarkVisitBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsCheckMarkVisitBizActionVO)valueObject;

                //Typecast the "valueObject" to "clsInputOutputVO"
                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsCheckMarkVisitBizActionVO)objBaseAppointmentDAL.CheckMarkVisit(obj, objUserVO);
                }
