...
{
    internal class clsGetFutureAppointmentBizAction : BizAction
    {
        ...
        public clsGetFutureAppointmentBizAction()
        {
        ...
        private static clsGetFutureAppointmentBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetFutureAppointmentBizAction();
        ...
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            ...
            clsGetFutureAppointmentBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetFutureAppointmentBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseAppointmentDAL objBaseAppointmentDAL = clsBaseAppointmentDAL.GetInstance();
                    obj = (clsGetFutureAppointmentBizActionVO)objBaseAppointmentDAL.GetFutureAppointment(obj, objUserVO);
                }
            }
