...
{
    internal class clsGetQueueByIDBizAction : BizAction
    {
        ...
        private clsGetQueueByIDBizAction()
        {
        ...
        private static clsGetQueueByIDBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetQueueByIDBizAction();
        ...
        {
            clsGetQueueByIDBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetQueueByIDBizActionVO)valueObject;
                if (obj != null)
                {
                    clsBaseQueueDAL objBaseQueueDAL = clsBaseQueueDAL.GetInstance();
                    obj = (clsGetQueueByIDBizActionVO)objBaseQueueDAL.GetQueueByID(obj, objUserVO);
                }
            }
