...
{
    internal class clsGetSecondLastVisitBizAction : BizAction
    {
        protected override IValueObject ProcessRequest(IValueObject valueObject, clsUserVO objUserVO)
        {
            bool CurrentMethodExecutionStatus = true;
            clsGetSecondLastVisitBizActionVO obj = null;
            int ResultStatus = 0;
            try
            {
                obj = (clsGetSecondLastVisitBizActionVO)valueObject;
                ...
                if (obj != null)
                {
                    ...
                    obj = (clsGetSecondLastVisitBizActionVO)objBaseDAL.GetSecondLastVisit(obj, objUserVO);
                }
            }
        ...
        private clsGetSecondLastVisitBizAction()
        {
        ...
        private static clsGetSecondLastVisitBizAction _Instance = null;
        ...
        {
            if (_Instance == null)
                _Instance = new clsGetSecondLastVisitBizAction();
