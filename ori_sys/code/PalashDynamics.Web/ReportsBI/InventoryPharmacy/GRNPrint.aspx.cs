...
namespace PalashDynamics.Web.ReportsBI.InventoryPharmacy
{
    public partial class GRNPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //myDoc.Load(Server.MapPath("invGRNforPrint.rpt"));
            myDoc.Load(Server.MapPath("NewinvGRNforPrint.rpt"));
            ...
            myDoc.SetParameterValue("@ID", str, "rptSubGRNFreeItems.rpt");
            myDoc.SetParameterValue("@UnitID", UnitID, "rptSubGRNFreeItems.rpt");
