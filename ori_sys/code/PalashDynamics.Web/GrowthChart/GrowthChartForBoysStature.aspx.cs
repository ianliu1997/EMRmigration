...
{
    public partial class GrowthChartForBoysStature : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                objGrowthChartYearly = (clsGetPatientGrowthChartYearlyBizActionVO)service.Process(objGrowthChartYearly, new clsUserVO());
                {
                    ...
                    {
                        n1 = n1 + 12;
                        g.DrawString(Convert.ToString(item.VisitDate.ToShortDateString()), new Font(new FontFamily("Arial"), 6, FontStyle.Bold), Brushes.Black,
                                  new Rectangle(55, n1, 80, 50));
                        g.DrawString(Convert.ToString(item.Age), new Font(new FontFamily("Arial"), 6, FontStyle.Bold), Brushes.Black,
