...
{
    public partial class SingleGrowthChartForBoysHCAndWeight : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                String path1 = Server.MapPath("~/GrowthChart/Image/HCWtBoys.bmp");
                ...
                g.DrawString(Convert.ToString(VisitDate.ToShortDateString()), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(50 + 230 - 5, 814, 80, 50));
                g.DrawString(Convert.ToString(age), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(130 + 220 - 10, 814, 80, 50));
                g.DrawString(Convert.ToString(Weight), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(188 + 210 - 10, 814, 80, 50));
                g.DrawString(Convert.ToString(Length), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(260 + 190 - 10, 814, 80, 50));
                g.DrawString(Convert.ToString(HC), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Red,
                          new Rectangle(315 + 200 - 10, 814, 80, 50));
                g.DrawString(Comments, new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                        new Rectangle(315 + 237 - 10 - 6, 814, 300, 250));
                ...
                {
                    Rectangle rect2 = new Rectangle(138 - 2 + x_Length, 836 - y_Weight, 2, 2);
                ...
                {
                    Rectangle rect3 = new Rectangle(139 - 1 + x_Age, 549 + 1 - y_HC, 2, 2);
