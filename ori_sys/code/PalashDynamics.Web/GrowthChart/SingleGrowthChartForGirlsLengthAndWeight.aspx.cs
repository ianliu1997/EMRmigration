...
{
    public partial class SingleGrowthChartForGirlsLengthAndWeight : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    age = Convert.ToDouble(Request.QueryString["AgeInMonth"]);
                }
                if (Request.QueryString["Length"] != null)
                {
                    Length = Convert.ToDouble(Request.QueryString["Length"]);
                }
                ...
                g.DrawString(Convert.ToString(VisitDate.ToShortDateString()), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(50 + 230 - 4, 792, 80, 50));
                g.DrawString(Convert.ToString(age), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(130 + 220 - 4, 792, 80, 50));
                g.DrawString(Convert.ToString(Weight), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(188 + 210 - 4, 792, 80, 50));
                g.DrawString(Convert.ToString(Length), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Blue,
                          new Rectangle(260 + 190 - 4, 792, 80, 50));
                g.DrawString(Convert.ToString(HC), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                          new Rectangle(315 + 200 - 4, 792, 80, 50));
                g.DrawString(Comments, new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Black,
                        new Rectangle(315 + 237 - 4, 792, 300, 250));
                ...
                {
                    Rectangle rect5 = new Rectangle(148 - 4 + 2 + x, 593 - 2 - y_Length, 3, 3);
                ...
                else
                {
                    if (Weight < 2)
                    {
                        Rectangle rect3 = new Rectangle(148 - 4 + 2 + x, 866 - 2 - y_Weight, 3, 3);
                        g.DrawEllipse(drawingPen, rect3);
                    }
                    else
                    {
                        Rectangle rect4 = new Rectangle(148 - 4 + 2 + x, 866 - 2 - 21 - y_Weight, 3, 3);
