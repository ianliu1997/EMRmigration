...
{
    public partial class GrowthChartForGirlsStature : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                objGrowthChartYearly = (clsGetPatientGrowthChartYearlyBizActionVO)service.Process(objGrowthChartYearly, new clsUserVO());
                {
                    ...
                    {
                        n1 = n1 + 12;
                        g.DrawString(Convert.ToString(item.VisitDate.ToShortDateString()), new Font(new FontFamily("Verdana"), 6, FontStyle.Bold), Brushes.Black,
                                  new Rectangle(50, n1, 80, 50));
                        g.DrawString(Convert.ToString(item.Age), new Font(new FontFamily("Verdana"), 6, FontStyle.Bold), Brushes.Black,
                                  new Rectangle(130, n1, 80, 50));
                        g.DrawString(Convert.ToString(item.Weight), new Font(new FontFamily("Verdana"), 6, FontStyle.Bold), Brushes.Blue,
                                  new Rectangle(188, n1, 80, 50));
                        g.DrawString(Convert.ToString(item.Height), new Font(new FontFamily("Verdana"), 6, FontStyle.Bold), Brushes.Black,
                                  new Rectangle(260, n1, 80, 50));
                        g.DrawString(Convert.ToString(item.BMI), new Font(new FontFamily("Verdana"), 6, FontStyle.Bold), Brushes.Black,
                                  new Rectangle(315 - 5, n1, 80, 50));
