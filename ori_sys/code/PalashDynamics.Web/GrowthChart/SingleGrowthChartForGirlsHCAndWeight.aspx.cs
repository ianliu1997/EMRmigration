...
{
    public partial class SingleGrowthChartForGirlsHCAndWeight : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                g.DrawString(Convert.ToString(HC), new Font(new FontFamily("Verdana"), 5, FontStyle.Bold), Brushes.Blue,
