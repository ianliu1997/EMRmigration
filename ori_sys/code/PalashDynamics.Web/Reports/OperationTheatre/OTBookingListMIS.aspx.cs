...
{
    public partial class OTBookingListMIS : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("OTBookingListRpt.rpt"));
            ...
            {
                DocID = Convert.ToInt64(Request.QueryString["DocID"]);
            }
            if (Request.QueryString["StaffID"] != null && Request.QueryString["StaffID"] != "0")
            {
                StaffID = Convert.ToInt64(Request.QueryString["StaffID"]);
            }
            ...
            myDoc.SetParameterValue("@StaffID",StaffID);
