...
{
    public partial class Patientfile4 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("PatientFile4.rpt"));
            long PatientId = 0;
            ...
            myDoc.SetParameterValue("@PatientId", PatientId, "MaleTest");
            myDoc.SetParameterValue("@PatientUnitId", PatientUnitId, "MaleTest");
