...
{
    public partial class Rpt_IVFDashboard_InvestigationDonar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("Rpt_IVFDashboardInvestigationDonar.rpt"));
            ...
            if (Request.QueryString["Gender"] != null && Request.QueryString["Gender"] != "")
            {
            ...
            myDoc.SetParameterValue("@Gender", Gender);
