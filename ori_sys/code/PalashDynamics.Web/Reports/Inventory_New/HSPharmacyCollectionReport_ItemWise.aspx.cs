...
{
    public partial class HSPharmacyCollectionReport_ItemWise : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            bool Excel = false;
            long store = 0;
            myDoc.Load(Server.MapPath("~Inventory_New\rpt_HSPharmacyCollectionReport_ItemWise_New.rpt"));
            ...
            myDoc.SetParameterValue("@FromDate", DTF, "SubReportRefund");
            myDoc.SetParameterValue("@ToDate", DTT, "SubReportRefund");
            myDoc.SetParameterValue("@ClinicId", clinic, "SubReportRefund");
            myDoc.SetParameterValue("@StoreID", store, "SubReportRefund");
