...
{
    public partial class PathoBarcodePrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                myDoc.Load(Server.MapPath("PathoBarcodePrint.rpt"));
                long ID = 0;
                long UnitID = 0;
                ...
                myDoc.SetParameterValue("@PathOrderBookingDetailID", ID);
