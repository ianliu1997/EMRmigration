...
{
    public partial class PendingPR_DashBoard : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string PRNo = Convert.ToString(Request.QueryString["PRNo"]);
            ...
            //  bool IsIndent = true;
            myDoc.Load(Server.MapPath("rptPendingPR_DashBoard.rpt"));
            ...
            myDoc.SetParameterValue("@Isindent", false);
            myDoc.SetParameterValue("@IndentNO", PRNo);
