...
{
    public partial class DailyPharmacySalesDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("crDailyPharmacySalesDetailReport.rpt"));
            ...
            myDoc.SetParameterValue("@UnitID", clinicId, "rptUnitLogo.rpt"); //Added by ajit jadhav date 28/11/2016 Get Unit LOGO
