...
{
    public partial class GRNLedgerDetailsReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("GRNLedgerDetailsReportFile.rpt"));
            ...
            if (Request.QueryString["MrNo"] != null && Request.QueryString["MrNo"].Length > 0)
            {
