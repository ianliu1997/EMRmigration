...
{
    public partial class ReturnItemPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            long str = Convert.ToInt64(Request.QueryString["ReturnID"]);
            long str1 = Convert.ToInt64(Request.QueryString["UnitID"]);
            myDoc = new ReportDocument();
        
            myDoc.Load(Server.MapPath("ReturnItemPrint1.rpt"));
            myDoc.SetParameterValue("@ReturnID", str);
