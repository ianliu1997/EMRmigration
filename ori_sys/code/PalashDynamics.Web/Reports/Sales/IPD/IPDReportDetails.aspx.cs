...
{
    public partial class IPDReportDetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("rptIPDReportDetails.rpt"));
            ...
            if (Request.QueryString["WardID"] != null)
            {
                WardID = Convert.ToInt64(Request.QueryString["WardID"]);
            }
            ...
            myDoc.SetParameterValue("@WardID", WardID );
