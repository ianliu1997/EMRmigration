...
{
    public partial class RevenueTradeReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //String strReportName = "  Revenue Report";
            ...
            myDoc.Load(Server.MapPath("RptRevenueTrend.rpt"));
            ...
            {
                FrDT = Convert.ToDateTime(FromYear);
            }

            if (!string.IsNullOrEmpty(ToYear))
            {
                ToDT = Convert.ToDateTime(ToYear);              
            }
            ...
            {
                lUnitId = Convert.ToInt64(Request.QueryString["UnitID"]);
            }
            ...
            myDoc.SetParameterValue("@FromYear", FrDT);
            myDoc.SetParameterValue("@ToYear", ToDT);
            myDoc.SetParameterValue("@UnitId", lUnitId);            
