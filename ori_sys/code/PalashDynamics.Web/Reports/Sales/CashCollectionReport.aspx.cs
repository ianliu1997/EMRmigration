...
{
    public partial class CashCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("CashCollection.rpt"));
            ...
            myDoc.SetParameterValue("@FromDate", FromDate, "RptSubCashCollection");
            myDoc.SetParameterValue("@ToDate", ToDate, "RptSubCashCollection");
            myDoc.SetParameterValue("@FromDate", FromDate, "SubReport2");
            myDoc.SetParameterValue("@ToDate", ToDate, "SubReport2");
