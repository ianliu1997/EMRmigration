...
{
    public partial class ServiceWiseDailyCollectionReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("ServiceWiseDailyCollection.rpt"));
            ...
            myDoc.SetParameterValue("@ServiceID", ServiceID);
            myDoc.SetParameterValue("@clincID", clinicID);
