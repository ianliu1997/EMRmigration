...
{
    public partial class PatientAdvanceConsumed : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("rptAdvanceConsumedDetails.rpt"));
            ...
            if (Request.QueryString["counterID"] != null && Request.QueryString["counterID"] != "")
            {
