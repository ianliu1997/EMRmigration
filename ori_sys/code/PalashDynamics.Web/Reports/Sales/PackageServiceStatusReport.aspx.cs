...
{
    public partial class PackageServiceStatusReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //IsPackage = Convert.ToInt64(Request.QueryString["IsPackage"]);

            //if (IsPackage > 0)
            //{
            //    myDoc.Load(Server.MapPath("Rpt_PackageServiceBookingReport.rpt"));
            //}
            //else
            //{
            //    myDoc.Load(Server.MapPath("Rpt_ServicewiseBillingreport.rpt"));
            //}

            myDoc.Load(Server.MapPath("Rpt_PackageServiceStatusReport.rpt"));
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["MrNo"]))
            {
