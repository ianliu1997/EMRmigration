...
{
    public partial class PatientRadiologydetails : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("rptPatientRadiologyDetails.rpt"));
            ...
            myDoc.SetParameterValue("@PatientID", PatientID, "EMRRadiology");
            myDoc.SetParameterValue("@VisitID", VisitID, "EMRRadiology");
            myDoc.SetParameterValue("@IsOPDIPD", bIsOPDIPD, "EMRRadiology");
            myDoc.SetParameterValue("@UnitID", unitid, "EMRRadiology");
