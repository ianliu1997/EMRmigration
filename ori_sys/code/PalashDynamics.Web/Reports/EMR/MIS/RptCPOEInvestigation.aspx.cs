...
namespace PalashDynamics.Web.Reports.EMR.MIS
{
    public partial class RptCPOEInvestigation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("RptEMRCPOEInverstigation.rpt"));
            ...
            myDoc.SetParameterValue("@UnitID", lUnitId, "Header");
