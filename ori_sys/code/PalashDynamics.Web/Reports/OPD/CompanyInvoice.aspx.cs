...
namespace PalashDynamics.Web.Reports.OPD
{
    public partial class CompanyInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            myDoc.Load(Server.MapPath("rptBillCompanyInvoiceReport.rpt"));
            ...
            //myDoc.SetParameterValue("@UnitID", UnitID, "rptClinicalInfo");

            myDoc.SetParameterValue("@UnitID", UnitID, "rptCommonReportHeader.rpt");
            myDoc.SetParameterValue("@UnitID", UnitID, "rptUnitLogo.rpt"); //Added by CDS date 01/12/2016 Get Unit LOGO
