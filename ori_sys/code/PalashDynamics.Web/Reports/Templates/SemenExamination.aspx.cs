...
namespace PalashDynamics.Web.Reports.Templates
{
    public partial class SemenExamination : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String strReportName = "Semen Examination Report";
            ...
            strConnection = "server=" + dbServer + ";database=" + dbName + ";uid=" + dbUserName + ";pwd=" + dbUserPassword + "";           long UnitId;
            long TemplateId;
            long PatientId;
            long PatientUnitId;
            long EMRId;
            myDoc = new ReportDocument();
            myDoc.Load(Server.MapPath("rpt_SemenExamination.rpt"));
