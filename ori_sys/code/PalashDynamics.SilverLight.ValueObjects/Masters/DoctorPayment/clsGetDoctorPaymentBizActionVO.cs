...
namespace PalashDynamics.ValueObjects.Master.DoctorPayment
{
    public class clsGetDoctorPaymentBizActionVO : IBizActionValueObject
    {
        ...
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorPaymentBizAction";
        }
    ...
    public class clsGetDoctorPaymentChildBizActionVO : IBizActionValueObject
    {
        ...
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorPaymentChildBizAction";
        }
    ...
    public class clsGetDoctorPaymentShareDetailsBizActionVO : IBizActionValueObject
    {
        ...
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorSharePaymentBizAction";
        }
    ...
    public class clsGetDoctorPaymentDetailListBizActionVO : IBizActionValueObject
    {
        ...
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorPaymentDetailListBizAction";
        }
