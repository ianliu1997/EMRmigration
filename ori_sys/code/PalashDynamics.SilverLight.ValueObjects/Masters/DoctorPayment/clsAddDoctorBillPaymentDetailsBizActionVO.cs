...
{
    public class clsAddDoctorBillPaymentDetailsBizActionVO : IBizActionValueObject
    {
        ...
        public long DoctorPaymentUnitId { get; set; }
        ...
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsAddDoctorBillPaymentDetailsBizAction";
        }
