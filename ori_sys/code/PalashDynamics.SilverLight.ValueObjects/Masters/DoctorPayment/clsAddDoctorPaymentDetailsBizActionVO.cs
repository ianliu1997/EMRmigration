...
{
    public class clsAddDoctorPaymentDetailsBizActionVO:IBizActionValueObject
    {
        ...
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsAddDoctorPaymentDetailsBizAction";
        }
