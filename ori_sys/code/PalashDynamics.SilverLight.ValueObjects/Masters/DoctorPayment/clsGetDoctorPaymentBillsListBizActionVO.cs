...
{
    public class clsGetDoctorPaymentBillsListBizActionVO:IBizActionValueObject
    {
        ...
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorPaymentBillsListBizAction";
        }
