...
{
    public class clsGetDoctorPaymentListBizActionVO : IBizActionValueObject
    {
        ...
        {
            return "PalashDynamics.BusinessLayer.Master.DoctorPayment.clsGetDoctorPaymentListBizAction";
        }
