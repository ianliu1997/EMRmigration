...
Public Class WeeklyServicewiseCollection
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Palash_Auto_Email_Notifications.WeeklyServicewiseCollection.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWeeklyServicewiseCollection
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WeeklyServicewiseCollection = New WeeklyServicewiseCollection()
        rpt.Site = Me.Site
        Return rpt
    End Function
