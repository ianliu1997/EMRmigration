...
namespace PalashDynamics.DataAccessLayer.BaseDataAccessLayer.RateContract
{
   public abstract class clsBaseRateContractDAL
    {
       static private clsBaseRateContractDAL _instance = null;
       ...
       public static clsBaseRateContractDAL GetInstance()
        {
            try
            {
                if (_instance == null)
                {
                    ...
                    string _DerivedClassName = "RateContract.clsRateContractDAL";
                    string FullQualifiedDerivedClassName = HMSConfigurationManager.GetDataAccesslayerNameSpace() + "." + _DerivedClassName;
                    //Create instance of Database dependent dataaccesslayer class and type cast it base class.
                    _instance = (clsBaseRateContractDAL)Activator.CreateInstance(Type.GetType(FullQualifiedDerivedClassName), true);
                }
            }
            catch (Exception ex)
            {
