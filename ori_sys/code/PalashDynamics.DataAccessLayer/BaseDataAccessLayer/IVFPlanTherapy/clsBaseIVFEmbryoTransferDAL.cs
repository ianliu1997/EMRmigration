...
namespace PalashDynamics.DataAccessLayer.BaseDataAccessLayer.IVFPlanTherapy
{
    ...
    {
        static private clsBaseIVFEmbryoTransferDAL _instance = null;
        ...
        public static clsBaseIVFEmbryoTransferDAL GetInstance()
        {
            try
            {
                if (_instance == null)
                {
                    ...
                    string _DerivedClassName = "clsIVFEmbryoTransferDAL";
                    string FullQualifiedDerivedClassName = HMSConfigurationManager.GetDataAccesslayerNameSpace() + "." + _DerivedClassName;
                    //Create instance of Database dependent dataaccesslayer class and type cast it base class.
                    _instance = (clsBaseIVFEmbryoTransferDAL)Activator.CreateInstance(Type.GetType(FullQualifiedDerivedClassName), true);
                }
            }
            catch (Exception ex)
            {
