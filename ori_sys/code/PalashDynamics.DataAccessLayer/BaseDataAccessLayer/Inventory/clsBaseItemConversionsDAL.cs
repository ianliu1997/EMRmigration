...
namespace PalashDynamics.DataAccessLayer.BaseDataAccessLayer.Inventory
{
    ...
    {
        static private clsBaseItemConversionsDAL _instance = null;
        ...
        public static clsBaseItemConversionsDAL GetInstance()
        {
            try
            {
                if (_instance == null)
                {
                    ...
                    string _DerivedClassName = "clsItemConversionsDAL";
                    string FullQualifiedDerivedClassName = HMSConfigurationManager.GetDataAccesslayerNameSpace() + "." + _DerivedClassName;
                    //Create instance of Database dependent dataaccesslayer class and type cast it base class.
                    _instance = (clsBaseItemConversionsDAL)Activator.CreateInstance(Type.GetType(FullQualifiedDerivedClassName), true);
                }
            }
            catch (Exception ex)
            {
