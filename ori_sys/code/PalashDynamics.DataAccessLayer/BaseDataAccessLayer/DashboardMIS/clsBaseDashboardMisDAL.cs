...
namespace PalashDynamics.DataAccessLayer.BaseDataAccessLayer.DashboardMIS
{
    ...
    {
        static private clsBaseDashboardMisDAL _instance = null;
        ...
        public static clsBaseDashboardMisDAL GetInstance()
        {
            try
            {
                if (_instance == null)
                {
                    ...
                    string _DerivedClassName = "DashboardMIS.clsDashboardMisDAL";
                    string FullQualifiedDerivedClassName = HMSConfigurationManager.GetDataAccesslayerNameSpace() + "." + _DerivedClassName;
                    //Create instance of Database dependent dataaccesslayer class and type cast it base class.
                    _instance = (clsBaseDashboardMisDAL)Activator.CreateInstance(Type.GetType(FullQualifiedDerivedClassName), true);
                }
            }
            catch (Exception ex)
            {
