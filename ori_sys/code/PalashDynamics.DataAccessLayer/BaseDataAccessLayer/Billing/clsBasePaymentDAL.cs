...
namespace PalashDynamics.DataAccessLayer.BaseDataAccessLayer.Billing
{
    public abstract class clsBasePaymentDAL
    {
        ...
        static private clsBasePaymentDAL _instance = null;
        ...
        public static clsBasePaymentDAL GetInstance()
        {
            try
            {
                if (_instance == null)
                {
                    ...
                    string _DerivedClassName = "clsPaymentDAL";
                    string FullQualifiedDerivedClassName = HMSConfigurationManager.GetDataAccesslayerNameSpace() + "." + _DerivedClassName;
                    //Create instance of Database dependent dataaccesslayer class and type cast it base class.
                    _instance = (clsBasePaymentDAL)Activator.CreateInstance(Type.GetType(FullQualifiedDerivedClassName), true);
                }
            }
            catch (Exception ex)
            {
