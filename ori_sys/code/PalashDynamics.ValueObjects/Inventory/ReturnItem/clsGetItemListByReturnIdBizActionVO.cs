...
{
    public class clsGetItemListByReturnIdBizActionVO : IBizActionValueObject
    {
        #region  IBizActionValueObject
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Inventory.clsGetItemListByReturnIdBizAction";
        }
        ...
        public List<clsReturnItemDetailsVO> ItemList { get; set; }
        public List<clsReceivedItemAgainstReturnDetailsVO> ItemListAgainstReturn { get; set; }
    ...
    public class clsReturnItemDetailsVO : INotifyPropertyChanged
    {
        ...
        public long ReasonForIssue { get; set; }
      ...
      //..............................................................
        ...
        private long? _ReceivedItemDetailsID;
        public long? ReceivedItemDetailsID
        {
            get
            {
                return _ReceivedItemDetailsID;
            }
            set
            {
                if (value != _ReceivedItemDetailsID)
                {
                    _ReceivedItemDetailsID = value;
                    OnPropertyChanged("ReceivedItemDetailsID");
                }
            }
        }
        ...
        //private long? _ReceivedBatchId;
        //public long? ReceivedBatchId
        //{
        //    get
        //    {
        //        return _ReceivedBatchId;
        //    }
        //    set
        //    {
        //        if (value != _ReceivedBatchId)
        //        {
        //            _ReceivedBatchId = value;
        //            OnPropertyChanged("ReceivedBatchId");
        //        }
        //    }
        //}
        ...
        public decimal ReturnQty
        {
            ...
            set
            {
                if (value != _ReturnQty)
                {
                    ...
                    //ItemTotalAmount = ReturnQty * PurchaseRate;
                    //ItemVATAmount = ItemTotalAmount * (ItemVATPercentage / 100);
                    // BalanceQty = ReturnQty-ReturnQty ;
                }
            }
        }
        ...
        private float _TotalPatientIndentReceiveQty;
        public float TotalPatientIndentReceiveQty
        {
            get
            {
                return _TotalPatientIndentReceiveQty;
            }
            set
            {
        ...
        private float _TotalPatientIndentConsumptionQty;
        public float TotalPatientIndentConsumptionQty
        {
            get
            {
                return _TotalPatientIndentConsumptionQty;
            }
            set
            {
                if (_TotalPatientIndentConsumptionQty != value)
                {
                    ...
                    OnPropertyChanged("TotalPatientIndentConsumptionQty");
                }
            }
        }
    }
