...
{
   public class clsAddOpeningBalanceDetailBizActionVO: IBizActionValueObject
    {
        ...
        {
            return "PalashDynamics.BusinessLayer.Inventory.clsAddOpeningBalanceDetailBizAction";
        }
