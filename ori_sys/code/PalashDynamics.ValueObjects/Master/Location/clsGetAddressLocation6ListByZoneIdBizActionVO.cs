...
{
    public class clsGetAddressLocation6ListByZoneIdBizActionVO : IBizActionValueObject
    {
        #region IBizActionValueObject Members

        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Master.Location.clsGetAddressLocation6ListByZoneIdBizAction";
        }
