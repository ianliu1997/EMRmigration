...
{
    public class clsAddUpdateCurrencyMasterListBizActionVO : IBizActionValueObject
    {
        #region  IBizActionValueObject
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Master.clsAddUpdateCurrencyMasterListBizAction";
        }
    ...
    public class clsCurrencyMasterListVO
    {
