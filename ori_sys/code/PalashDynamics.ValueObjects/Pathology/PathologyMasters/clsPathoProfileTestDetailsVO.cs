...
{
    public class clsPathoProfileTestDetailsVO : IValueObject, INotifyPropertyChanged
    {
        #region IValueObject
        public string ToXml()
        {
        ...
        private bool _IsEntryFromTestMaster;
        public bool IsEntryFromTestMaster
        {
            get { return _IsEntryFromTestMaster; }
            set
            {
                if (_IsEntryFromTestMaster != value)
                {
                    _IsEntryFromTestMaster = value;
                    OnPropertyChanged("IsEntryFromTestMaster");
                }
            }
        }
