...
{
    public class clsFemaleLabDay1VO : IValueObject, INotifyPropertyChanged
    {
        #region Property Declaration Section

        public clsLabDaysSummaryVO LabDaySummary { get; set; }
        public List<clsFemaleLabDay1InseminationPlatesVO> ObservationDetails { get; set; }

        public List<clsFemaleLabDay1FertilizationAssesmentVO> FertilizationAssesmentDetails { get; set; }
    ...
    public class clsFemaleLabDay1InseminationPlatesVO : IValueObject, INotifyPropertyChanged
    {
        ...
        private double _HrAtIns;
        public double HrAtIns
        {
            get { return _HrAtIns; }
            set
            {
        ...
        private string _FertiCheckPeriod;
        public string FertiCheckPeriod
        {
            get { return _FertiCheckPeriod; }
            set
            {
                if (_FertiCheckPeriod != value)
                {
                    _FertiCheckPeriod = value;
                    OnPropertyChanged("FertiCheckPeriod");
                }
            }
        }
    ...
    public class clsFemaleLabDay1FertilizationAssesmentVO : IValueObject, INotifyPropertyChanged
    {
        public List<clsFemaleMediaDetailsVO> MediaDetails { get; set; }

        public clsFemaleLabDay1CalculateDetailsVO CalculateDetails { get; set; }
        ...
        private bool _ProceedDay2;
        public bool ProceedDay2
        {
            get { return _ProceedDay2; }
            set
            {
                if (_ProceedDay2 != value)
                {
                    _ProceedDay2 = value;
                    OnPropertyChanged("ProceedDay2");
                }
            }
        }
        ...
        //-------- To Link LabDay1 with T_IVFPlanTherapy.PlanTherapyId ------------------
    ...
    public class clsFemaleLabDay1CalculateDetailsVO : IValueObject, INotifyPropertyChanged
    {
        private long _ID;
        public long ID
        {
        ...
        private bool _TwoPNClosed;
        public bool TwoPNClosed
        {
            get { return _TwoPNClosed; }
            set
            {
                if (_TwoPNClosed != value)
                {
                    _TwoPNClosed = value;
                    OnPropertyChanged("TwoPNClosed");
                }
            }
        }
        private bool _TwoPNSeparated;
        public bool TwoPNSeparated
        {
            get { return _TwoPNSeparated; }
            set
            {
                if (_TwoPNSeparated != value)
                {
                    _TwoPNSeparated = value;
                    OnPropertyChanged("TwoPNSeparated");
                }
            }
        }

        private bool _NucleoliAlign;
        public bool NucleoliAlign
        {
            get { return _NucleoliAlign; }
            set
            {
                if (_NucleoliAlign != value)
                {
                    _NucleoliAlign = value;
                    OnPropertyChanged("NucleoliAlign");
                }
            }
        }
        private bool _BeginningAlign;
        public bool BeginningAlign
        {
            get { return _BeginningAlign; }
            set
            {
                if (_BeginningAlign != value)
                {
                    _BeginningAlign = value;
                    OnPropertyChanged("BeginningAlign");
                }
            }
        }
        ...
        {
            get { return _Scattered; }
            set
            {
                if (_Scattered != value)
                {
                    _Scattered = value;
                    OnPropertyChanged("Scattered");
                }
            }
        }

        private bool _CytoplasmHetero;
        public bool CytoplasmHetero
        {
            get { return _CytoplasmHetero; }
            set
            {
                if (_CytoplasmHetero != value)
                {
                    _CytoplasmHetero = value;
                    OnPropertyChanged("CytoplasmHetero");
                }
            }
        }

        private bool _CytoplasmHomo;
        public bool CytoplasmHomo
        {
            get { return _CytoplasmHomo; }
            set
            {
                if (_CytoplasmHomo != value)
                {
                    _CytoplasmHomo = value;
                    OnPropertyChanged("CytoplasmHomo");
                }
            }
        }


        private bool _NuclearMembrane;
        public bool NuclearMembrane
        {
            get { return _NuclearMembrane; }
            set
            {
                if (_NuclearMembrane != value)
                {
                    _NuclearMembrane = value;
                    OnPropertyChanged("NuclearMembrane");
                }
            }
        }
