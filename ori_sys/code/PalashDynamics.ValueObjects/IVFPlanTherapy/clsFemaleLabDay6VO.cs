...
namespace PalashDynamics.ValueObjects
{
    ...
    public class clsFemaleLabDay6VO : IValueObject, INotifyPropertyChanged
    {
        public clsLabDaysSummaryVO LabDaySummary { get; set; }

        public List<clsFemaleLabDay6FertilizationAssesmentVO> FertilizationAssesmentDetails { get; set; }
    ...
    public class clsFemaleLabDay6FertilizationAssesmentVO : IValueObject, INotifyPropertyChanged
    {
        ...
        private bool _ProceedDay7;
        public bool ProceedDay7
        {
            get { return _ProceedDay7; }
            set
            {
                if (_ProceedDay7 != value)
                {
                    _ProceedDay7 = value;
                    OnPropertyChanged("ProceedDay7");
                }
            }
        }
