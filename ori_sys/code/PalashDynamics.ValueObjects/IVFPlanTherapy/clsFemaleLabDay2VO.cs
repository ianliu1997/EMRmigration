...
{
   public class clsFemaleLabDay2VO : IValueObject, INotifyPropertyChanged
    {
       ...
       public clsLabDaysSummaryVO LabDaySummary { get; set; }
        ...
        public List<clsFemaleLabDay2FertilizationAssesmentVO> FertilizationAssesmentDetails { get; set; }
   ...
   public class clsFemaleLabDay2FertilizationAssesmentVO : IValueObject, INotifyPropertyChanged
   {
       public List<clsFemaleMediaDetailsVO> MediaDetails { get; set; }

       public clsFemaleLabDay2CalculateDetailsVO Day2CalculateDetails { get; set; }
       ...
       private bool _ProceedDay3;
       public bool ProceedDay3
       {
           get { return _ProceedDay3; }
           set
           {
               if (_ProceedDay3 != value)
               {
                   _ProceedDay3 = value;
                   OnPropertyChanged("ProceedDay3");
               }
           }
       }
       ...
       //---- Get LabDay1 PlanTherapyId To Link with LabDay2 PlanTherapyId
   ...
   public class clsFemaleLabDay2CalculateDetailsVO : IValueObject, INotifyPropertyChanged
   {
       private long _ID;
       public long ID
       {
       ...
       private int _ZonaThickness;
       public int ZonaThickness
       {
           get { return _ZonaThickness; }
           set
           {
               if (_ZonaThickness != value)
               {
                   _ZonaThickness = value;
                   OnPropertyChanged("ZonaThickness");
               }
           }
       }
       
       private int _ZonaTexture;
       public int ZonaTexture
       {
           get { return _ZonaTexture; }
           set
           {
               if (_ZonaTexture != value)
               {
                   _ZonaTexture = value;
                   OnPropertyChanged("ZonaTexture");
               }
           }
       }

       private int _BlastomereSize;
       public int BlastomereSize
       {
           get { return _BlastomereSize; }
           set
           {
               if (_BlastomereSize != value)
               {
                   _BlastomereSize = value;
                   OnPropertyChanged("BlastomereSize");
               }
           }
       }
      
       private int _BlastomereShape;
       public int BlastomereShape
       {
           get { return _BlastomereShape; }
           set
           {
               if (_BlastomereShape != value)
               {
                   _BlastomereShape = value;
                   OnPropertyChanged("BlastomereShape");
               }
           }
       }
       
       private int _BlastomeresVolume;
       public int BlastomeresVolume
       {
           get { return _BlastomeresVolume; }
           set
           {
               if (_BlastomeresVolume != value)
               {
                   _BlastomeresVolume = value;
                   OnPropertyChanged("BlastomeresVolume");
               }
           }
       }
       ...
       public int Membrane
       {
           ...
           set
           {
               ...
               {
                   _Membrane = value;
                   OnPropertyChanged("Membrane");
               }
           }
       }

       private int _Cytoplasm;
       ...
       public int Fragmentation
       {
           ...
           set
           {
               if (_Fragmentation != value)
               {
                   _Fragmentation = value;
                   OnPropertyChanged("Fragmentation");
               }
           }
       }

       private int _DevelopmentRate;
       public int DevelopmentRate
       {
           get { return _DevelopmentRate; }
           set
           {
               if (_DevelopmentRate != value)
               {
                   _DevelopmentRate = value;
                   OnPropertyChanged("DevelopmentRate");
               }
           }
       }
