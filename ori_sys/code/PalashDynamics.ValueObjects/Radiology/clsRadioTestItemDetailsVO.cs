...
{
   //public class clsRadioTestItemDetailsVO : IValueObject, INotifyPropertyChanged
   // {
   //    #region IValueObject
   //    public string ToXml()
   //    {
   ...
   // }
      ...
      #region Newly Added 
   //  public class clsRadioResultEntryTemplateVO : IValueObject, INotifyPropertyChanged
   //{
   //    #region IValueObject
   //    public string ToXml()
   //    {
   ...
   //}
     ...
     //public class clsRadioTestTemplateDetailsVO : IValueObject, INotifyPropertyChanged
     //{
     //    #region IValueObject
     //    public string ToXml()
     //    {
     ...
     //    //    }
     //    //}
     //    public List<clsRadiologyVO> RadiologyList { get; set; }
     //   // public List<clsRadItemDetailMasterVO> SupplierList { get; set; }
     //    public List<clsRadioTestTemplateDetailsVO> Radiologist { get; set; }
     ...
     //    private bool _MultipleRadioDoctor = false;
     //    public bool MultipleRadioDoctor
     //    {
     //        get { return _MultipleRadioDoctor; }
     //        set
     //        {
     //            if (_MultipleRadioDoctor != value)
     //            {
     //                _MultipleRadioDoctor = value;
     //                OnPropertyChanged("MultipleRadioDoctor");
     //            }
     //        }
     //    }
     ...
     //}
      ...
      //public class clsRadioTemplateVO : IValueObject, INotifyPropertyChanged
      //{
      //    #region IValueObject
      //    public string ToXml()
      //    {
