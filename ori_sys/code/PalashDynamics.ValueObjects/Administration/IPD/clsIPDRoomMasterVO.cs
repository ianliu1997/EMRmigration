...
{
    public class clsIPDRoomMasterVO:IValueObject, INotifyPropertyChanged
    {
        public string ToXml()
        {
            return this.ToXml();
        ...
        private bool _CheckedAllAmmenities;
        public bool CheckedAllAmmenities
        {
            get { return _CheckedAllAmmenities; }
            set
            {
                if (value != _CheckedAllAmmenities)
                {
                    _CheckedAllAmmenities = value;
                    OnPropertyChanged("CheckedAllAmmenities");
                }
            }
        }
    ...
    public class clsIPDRoomAmmenitiesMasterVO : IValueObject, INotifyPropertyChanged
    {
        public string ToXml()
        {
            return this.ToXml();
