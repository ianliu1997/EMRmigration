...
{
    public class clsAddUpdateCompanyAssociateBizActionVO : IBizActionValueObject
    {
        #region  IBizActionValueObject
        public string GetBizAction()
        {
            return "PalashDynamics.BusinessLayer.Administration.clsAddUpdateCompanyAssociateBizAction";
        }
    ...
    public class clsCompanyAssociateVO
    {
