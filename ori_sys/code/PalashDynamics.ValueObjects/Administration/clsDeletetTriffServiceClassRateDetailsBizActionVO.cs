...
{
   public class clsDeletetTriffServiceClassRateDetailsBizActionVO:IBizActionValueObject
    {
       public clsDeletetTriffServiceClassRateDetailsBizActionVO()
        {
        ...
        {
            return "PalashDynamics.BusinessLayer.Administration.clsDeletetTriffServiceClassRateDetailsBizAction";
        }
