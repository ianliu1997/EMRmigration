...
{
    class clsUpdateServiceMasterBizActionVO:IBizActionValueObject
    {

        public clsUpdateServiceMasterBizActionVO()
        {
        ...
        {
            return "PalashDynamics.BusinessLayer.Administration.clsUpdateServiceMasterBizAction";
        }
