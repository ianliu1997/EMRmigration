...
{
    public class clsProcedureInstructionDetailsVO : IValueObject, INotifyPropertyChanged
    {
        #region IValueObject
        public string ToXml()
        {
        ...
        private long _InstructionTypeID;
        public long InstructionTypeID
        {
            get
            {
            ...
            set
            {
                ...
                OnPropertyChanged("InstructionTypeID");
            }
        }
