...
{
    public class clsProcedureStaffDetailsVO : IValueObject, INotifyPropertyChanged
    {
        #region IValueObject
        public string ToXml()
        {
        ...
        private string _DocOrStaffCode;
        public string DocOrStaffCode
        {
            get
            {
                return _DocOrStaffCode;
            }
            set
            {
                _DocOrStaffCode = value;
                OnPropertyChanged("DocOrStaffCode");
            }
        }
        ...
        private long _DocOrStaffID;
        public long DocOrStaffID
        {
            get
            {
                return _DocOrStaffID;
            }
            set
            {
                _DocOrStaffID = value;
                OnPropertyChanged("DocOrStaffID");
            }
        }

        private long _NoofDocOrStaff;
        public long NoofDocOrStaff
        {
            get
            {
                return _NoofDocOrStaff;
            }
            set
            {
                _NoofDocOrStaff = value;
                OnPropertyChanged("NoofDocOrStaff");
            }
        }
