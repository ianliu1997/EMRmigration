...
{
    public class clsInstructionMasterVO :IValueObject, INotifyPropertyChanged
    {
        #region IValueObject
        public string ToXml()
        {
        ...
        List<MasterListItem> _Instruction = new List<MasterListItem>()
        {
            new MasterListItem {ID=0, Description="--Select--"},
            new MasterListItem {ID=1, Description="Pre Operation Instructions"},
            new MasterListItem {ID=2, Description="Intra Operation Instructions"},
            new MasterListItem {ID=3, Description="Post Operation Instructions"},
        };

        public List<MasterListItem> Instruction
        {
        ...
        MasterListItem _SelectInstruction = new MasterListItem { ID = 0, Description = "--Select--" };
        public MasterListItem SelectInstruction
        {
            get
            {
                return _SelectInstruction;
            }
            set
            {
                if (value != _SelectInstruction)
                {
                    _SelectInstruction = value;
