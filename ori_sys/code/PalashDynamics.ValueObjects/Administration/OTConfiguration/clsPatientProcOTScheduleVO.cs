...
{
    public class clsPatientProcOTScheduleVO : IValueObject, INotifyPropertyChanged
    {
        #region IValueObject
        public string ToXml()
        {
        ...
        private List<clsPatientProcOTScheduleDetailsVO> _OTScheduleList = new List<clsPatientProcOTScheduleDetailsVO>();
        public List<clsPatientProcOTScheduleDetailsVO> OTScheduleList
        {
            get
            {
                return _OTScheduleList;
            }
            set
            {
                _OTScheduleList = value;
            }
        }
    }
}
