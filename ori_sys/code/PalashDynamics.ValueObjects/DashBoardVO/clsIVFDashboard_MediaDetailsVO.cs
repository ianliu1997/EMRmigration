...
{
    public class clsIVFDashboard_MediaDetailsVO : IValueObject, INotifyPropertyChanged
    {
        ...
        private bool _StatusIS;
        public bool StatusIS
        {
            get { return _StatusIS; }
            set
            {
                if (_StatusIS != value)
                {
                    _StatusIS = value;
                    OnPropertyChanged("StatusIS");
                }
            }
        }
