...
{
    public partial class PurchaseOrder_SearchWindow : ChildWindow
    {
        ...
        private void FillPurchaseOrderList()
        {
            try
            {
                ...
                if (dtpFromDate.SelectedDate != null)
                    objBizActionVO.searchFromDate = dtpFromDate.SelectedDate.Value.Date;
                //else
                //    objBizActionVO.searchFromDate = dtpFromDate.SelectedDate = DateTime.Now.Date;

                if (dtpToDate.SelectedDate != null)
                    objBizActionVO.searchToDate = dtpToDate.SelectedDate.Value.Date;
                //else
                //    objBizActionVO.searchToDate = dtpToDate.SelectedDate = DateTime.Now.Date;
                ...
                Client.ProcessCompleted += (s, arg) =>
                {
                    if (arg.Error == null)
                    {
                        if (arg.Result != null)
                        {
                            ...
                            {
                                dgPurchaseOrder.ItemsSource = new PagedSortableCollectionView<clsPurchaseOrderVO>();
                                PODataPager.Source = new PagedSortableCollectionView<clsPurchaseOrderVO>();
                                dgPOItems.ItemsSource = new List<clsPurchaseOrderDetailVO>();
                            }
                        }
                        else
                        {
        ...
        public PurchaseOrder_SearchWindow()
        {
            InitializeComponent();
            this.Loaded += new RoutedEventHandler(PurchaseOrder_SearchWindow_Loaded);
        ...
        void PurchaseOrder_SearchWindow_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private ObservableCollection<clsPurchaseOrderDetailVO> _ItemsSelected;
        public ObservableCollection<clsPurchaseOrderDetailVO> ItemsSelected { get { return _ItemsSelected; } }

        private ObservableCollection<clsPurchaseOrderDetailVO> _SelectedPOItemList;
        public ObservableCollection<clsPurchaseOrderDetailVO> SelectedPOItemList { get { return _SelectedPOItemList; } }
            ...
            try
            {
                ...
                Client.ProcessCompleted += (s, e) =>
                {
                    if (e.Error == null && e.Result != null)
                    {
                        ...
                        FillPurchaseOrderList(); //Added By CDS 
        ...
        private void dgPurchaseOrder_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            {
                _SelectedPO = (clsPurchaseOrderVO)dgPurchaseOrder.SelectedItem;
        ...
        private void AddPOItem_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (dgPOItems.SelectedItem != null)
            {
                ...
                ObservableCollection<clsPurchaseOrderDetailVO> RemovedItemsSelected = new ObservableCollection<clsPurchaseOrderDetailVO>();
                RemovedItemsSelected = _ItemsSelected;
                CheckBox chk = (CheckBox)sender;
                if (chk.IsChecked == true)
                {
                    _ItemsSelected.Add((clsPurchaseOrderDetailVO)dgPOItems.SelectedItem);
                }
                else
                {
                    ...
                    {
                        if (RemovedItemsSelected[i].PoItemsID == ((clsPurchaseOrderDetailVO)dgPOItems.SelectedItem).PoItemsID && RemovedItemsSelected[i].ItemID == ((clsPurchaseOrderDetailVO)dgPOItems.SelectedItem).ItemID)
                        {
        ...
        private void CheckBox1_Click(object sender, RoutedEventArgs e)
        {
            ...
            ObservableCollection<clsPurchaseOrderDetailVO> RemovedItemsSelected1 = new ObservableCollection<clsPurchaseOrderDetailVO>();
            ...
            if (((CheckBox)sender).IsChecked == false)
            {
                ...
                {
                    if (RemovedItemsSelected1[i].PoItemsID == ((clsPurchaseOrderDetailVO)dgSelectedPOItemList.SelectedItem).PoItemsID && RemovedItemsSelected1[i].ItemID == ((clsPurchaseOrderDetailVO)dgSelectedPOItemList.SelectedItem).ItemID)
                    {
        ...
        private void FillPurchaseOrderDetailsList(long pPOID, long iUnitID)
        {
            try
            {
                ...
                objBizActionVO.IsFromGRNAgainstPOSearchWindow = true; // added by Ashish Z.
                        ...
                        if (arg.Result != null)
                        {
                            ...
                            if (_ItemsSelected != null)
                            {
                                foreach (var item in obj.PurchaseOrderList)
                                {
                                    ...
                                    {
                                        if (item.POID == item1.POID && item.ItemID == item1.ItemID)
                                        {
                            ...
                            foreach (var item in obj.PurchaseOrderList)
                            {
                                item.POFinalPendingQuantity = Convert.ToDouble(item.PendingQuantity) - Convert.ToDouble(item.GRNPendItemQuantity);
                                if (item.POFinalPendingQuantity < 0)
                                    item.POFinalPendingQuantity = 0;
                            }
        ...
        private void dgPOItems_LoadingRow(object sender, DataGridRowEventArgs e)
        {
            if (dgPOItems.ItemsSource != null)
            {
                if (((clsPurchaseOrderDetailVO)e.Row.DataContext).IsItemBlock)
                {
