...
namespace PalashDynamics.Pharmacy.Barcode
{
    public class Code128
    {
        ...
        //    Size size = g.MeasureString(code.Substring(0, 1));
        ...
        //            g.FillRectangle(brush, start, y, barwidth, height);
        //        }
        //        else // bit == "1"
        //        {

        //            g.FillRectangle(brush1, start, y, barwidth, height);
        //        }
        //        start += barwidth;
        //    }
        //    g.FillRectangle(brush, x, y + height - 8, width, 8);
        //    if (humanReadable)
        //    {
        //        //g.FillRectangle(brush, x + padding + ((barwidth) * 10), y + height - 20, barwidth * 36, 20);
        //        //g.FillRectangle(brush, x + padding + ((barwidth) * 49), y + height - 20, barwidth * 36, 20);

        //        //g.DrawString(code.Substring(0, 1), font, brush1, x + 2, y + height - font.Height);
        //        //int spacing = (int)((barwidth * 36) / 5);

        //        //for (int i = 1; i < 6; i++)
        //        //{
        //        //    g.DrawString(code.Substring(i, 1), font, brush1, x + (barwidth * 10) + padding + (spacing * (i - 1)), y + height - font.Height);
        //        //}
        //        //for (int i = 6; i < 11; i++)
        //        //{
        //        //    g.DrawString(code.Substring(i, 1), font, brush1, x + (barwidth * 49) + padding + (spacing * (i - 6)), y + height - font.Height);
        //        //}
        //        //g.DrawString(code.Substring(11, 1), font, brush1, x + ((barwidth) * 95) + padding, y + height - font.Height);
        //    }
        //    return "";
        //}
        ...
        //public string DrawCode128(string code, int x, int y)
        //{
        ...
        //    barwidth = (int)Math.Floor((double)(width - 2) / (barbit.Length + 20)); // add 20 for padding
        //    if (barwidth <= 0)
        //        barwidth = 1;
        ...
        public List<Rectangle> DrawCode128(string code, int x, int y)
        {
            ...
            int padding = Convert.ToInt32(barwidth * 5);
            if (centered)
            {
                x = Convert.ToInt32((int)x - (((barwidth * barbit.Length) + (padding * 2)) / 2));
            }
            //height = 40;
